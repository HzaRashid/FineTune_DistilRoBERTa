...
- I gathered the plot descriptions and reviews from the respective datasets, and labeled them as either 'Objective' or 'Subjective', respectively, in a final data frame consisting 10000 pieces of text, reduced to 240 characters (i.e., similar to Twitter), and evenly divided between the two categories.
